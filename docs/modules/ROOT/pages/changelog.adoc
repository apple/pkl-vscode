...
* Restrict which commands the LSP may run (pr:https://github.com/apple/pkl-vscode/pull/105[]).
...
* Add configuration option for module path (pr:https://github.com/apple/pkl-vscode/pull/90[]).

=== Changes

* Bump bundled version of pkl-lsp to 0.8.0 (pr:https://github.com/apple/pkl-vscode/pull/100[]).

=== Fixes

* Appropriately restrict LSP-provided commands in markdown content (pr:https://github.com/apple/pkl-vscode/pull/99[]).
